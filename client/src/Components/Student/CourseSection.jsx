  ...
  return (
    <div className="py-16 md:px-40 px-8">
      ...
      <p className="text-sm md:text-base text-gray-500 mt-3">
        Discover our best top notch courses across various categories.From
        Coding till Designing to
      ...
      <Link
        ...
        className="text-white hover:bg-blue-500 mt-4 border border-gray-500/30 px-10 py-3 rounded"
      >
        Explore More
      </Link>
    </div>
