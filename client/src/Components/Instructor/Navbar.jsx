        ...
        {isOpen && (
          <div className="absolute top-full right-0 mt-2 w-40 bg-white border rounded-lg shadow-lg transition-all duration-200">
            <ul className="py-2 text-gray-800">
              <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={()=>navigate('/instructor/instructor-profile')}>
                <img src={assets.user_icon} alt="user_icon" className="w-6 h-6 mr-2 inline-block"/>
                Profile
                </li>
              <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer" onClick={()=>navigate('/logout')}>
